...
const jsVersion = require('./scripts/js-version');
...
// Same treatment for the site's own JavaScript, which is cached for a week
// under names that never change. See scripts/js-version.js.
app.locals.jsVersion = jsVersion();
