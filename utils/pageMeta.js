...
const pages = {
  ...
  weddingMenu: {
    ...
    title: 'Indian Wedding Catering Menu List: 212 Veg Dishes',
    description: 'The Indian wedding veg food menu list we cook in Noida and Delhi NCR: 212 dishes across grazing, canapes, live stations, buffet and dessert.',
    ogImage: content.heroImage,
