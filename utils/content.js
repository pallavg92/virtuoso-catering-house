...
const blogPosts = [
  ...
  },
  {
    ...
    sections: [
      {
        heading: 'The Difference Between Feeding a Room and Building a Memory',
        paragraphs: [
      ...
      {
        heading: 'Luxury Without the Noise',
        paragraphs: [
      ...
      {
        heading: 'One Philosophy, Applied to Every Function',
        paragraphs: [],
        list: [
      ...
      },
      {
        ...
        paragraphs: [
          'None of this is loud. The best wedding catering rarely announces itself. A course lands exactly when it should. A guest\'s dietary need is handled before they think to mention it. The room quiets at the right moment because the food gave it permission to. That\'s the craft, not the spectacle of it, the quiet of it.'
        ]
      }
    ],
    faq: [
  ...
  ,{
    slug: 'welcome-drinks-for-guests',
    url: '/blog/welcome-drinks-for-guests',
    title: 'Welcome Drinks for Guests: Three Recipes to Serve',
    excerpt: 'Three non-alcoholic welcome drinks to serve your guests: butterfly pea lemonade, peach orange yuzu fizz and sparkling rose lemonade.',
    date: '2026-09-02',
    image: '/images/blog/welcome-drinks/virtuoso-catering-house-welcome-drinks-hero.jpg',
    relatedLink: { path: '/wedding-caterers-in-noida', label: 'See how we cater weddings in Noida' },
    downloadOffer: {
      eyebrow: 'Take Them With You',
      title: 'All Three,<br>On Three Cards',
      copy: 'Each drink on its own printable card: what you need, how to make it, and the notes that stop it going wrong. Hand it to whoever is behind the bar.',
      action: 'Send Me the Cards',
      asset: 'welcome-drinks-cards',
      privacy: 'We send the occasional seasonal menu and hosting note. Usually no more than twice a year.',
      dismiss: 'I\u2019ll keep reading'
    },
    lead: [
    ...
    sections: [
      {
        heading: '1. Butterfly Pea Flower Lemonade',
        ...
        steps: [
          'Fill your shaker with ice cubes or crushed ice.',
          'Add the butterfly pea concentrate, lemon juice and sugar syrup.',
          'Shake well until chilled.',
          'Pour into the glass.',
          'Top with sparkling soda and more ice.',
      ...
      {
        heading: '2. Peach Orange Yuzu Fizz',
        headingNote: 'Citrus. Aromatic.',
        paragraphs: [
        ...
        list: [
          ...
          'Yuzu juice, 10 ml',
          'Sugar syrup, 10 ml, depending on how sweet the peach syrup is',
          'Sparkling water, 80 to 100 ml',
          'Orange slice, and a peach slice or edible flower, to garnish'
        ],
        steps: [
          'Fill a shaker with ice.',
          'Add the peach syrup, orange juice, yuzu juice and sugar syrup.',
          'Shake well until chilled.',
          'Fill the serving glass with fresh ice.',
          'Strain the shaken mixture into the glass.',
          'Top slowly with sparkling water, then give it one gentle stir.',
      ...
      {
        heading: '3. Sparkling Rose Lemonade',
        ...
        list: [
          ...
          'Sugar syrup, 10 ml',
          'Rose sparkling water, 100 to 120 ml',
          'Cucumber ribbons, 3 to 4',
          'Thin lemon slices, and a rose petal or edible flower, to garnish'
        ],
        steps: [
          'Using a vegetable peeler, make long, thin cucumber ribbons.',
          'Gently curl two or three ribbons and place them inside the glass, letting them hug the sides.',
          'Fill the glass generously with ice.',
          'Add the lemon juice and sugar syrup.',
          'Top slowly with rose sparkling water.',
          'Give it one gentle stir, without losing the fizz.',
      ...
      },
      {
        ...
        paragraphs: [],
        table: {
          head: ['Drink', 'What it brings', 'Prepare ahead'],
          rows: [
            ['Butterfly Pea Lemonade', 'Colour and theatre, floral and light', 'Concentrate, up to 2 days'],
            ['Peach Orange Yuzu Fizz', 'Familiar and bright, the crowd-pleaser', 'Juice base, refrigerated'],
            ['Sparkling Rose Lemonade', 'Elegant and least sweet', 'Lemon base and ribbons, separately']
          ]
        }
      },
      {
        heading: 'Beyond these three',
        paragraphs: [
          'A welcome drink is the smallest part of an event menu and the first thing anybody judges it by.',
          'When we design beverage programmes for weddings, launches and private dinners across Delhi NCR, the welcome drink is chosen last, once we know what the room is and what follows it. A drink that works at a four o\u2019clock mehendi is the wrong drink for a nine o\u2019clock reception.',
          'We work from our kitchen and experience centre in Noida, Sector 61, and every menu is built for the specific event rather than pulled off a list.'
        ],
        links: [
          { path: '/contact', label: 'Talk to us about drinks for your event' },
          { path: '/wedding-caterers-in-noida', label: 'Wedding catering in Noida' },
          { path: '/luxury-brand-event-catering-delhi-ncr', label: 'Brand and launch catering in Delhi NCR' }
        ]
      }
...
const bestCaterersNoidaPage = {
  ...
  url: '/best-caterers-in-noida-virtuoso-catering-house',
  ...
  relatedLink: { path: '/best-catering-services-in-noida', label: 'See Our Catering Services in Noida' },
  lead: [
...
// This guide keeps its own top-level URL (already indexed, keyword-rich)
// but is also surfaced in the /blog Journal listing. Appending it to
// blogPosts is what makes it appear in that listing; its route and page
// metadata are still defined the standalone way in pageMeta.js.
blogPosts.push(bestCaterersNoidaPage);
...
const hireWeddingCaterersDelhiPage = {
  ...
  url: '/how-to-hire-wedding-caterers-in-delhi-for-a-luxury-wedding',
...
// blogPosts is what makes it appear in that listing; its route and page
// metadata are still defined the standalone way in pageMeta.js.
blogPosts.push(hireWeddingCaterersDelhiPage);
...
// Keeps its own top-level URL (already indexed) but is also surfaced in
// the /blog Journal listing, same treatment as hireWeddingCaterersDelhiPage.
blogPosts.push(bestWeddingCaterersDelhiPage);
...
// Keeps its own top-level URL (already indexed) but is also surfaced in
// the /blog Journal listing, same treatment as the other PDF-sourced guides.
blogPosts.push(caterersInDelhiFindingTheRightFitPage);
...
const aboutPage = {
  intro: {
    ...
    paragraphs: [
      'Virtuoso Catering House is a luxury catering and F&amp;B experience design company based in Noida, India, working across Delhi NCR. We create bespoke food and beverage experiences for <a href="/wedding-caterers-in-noida" class="link-underline">weddings</a>, private celebrations, and <a href="/luxury-brand-event-catering-delhi-ncr" class="link-underline">brand and product launches</a>, designing the menu, presentation and hospitality around the people, story and purpose of each event.',
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'From menu development and culinary concepts to presentation, grazing experiences, live food interactions and service formats, we design <a href="/luxury-brand-event-catering-delhi-ncr" class="link-underline">brand event catering</a> intended to feel native to the brand and the event around it.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'We work with couples, families and private hosts to create bespoke catering experiences for weddings, intimate gatherings and important celebrations, as <a href="/wedding-caterers-in-noida" class="link-underline">wedding caterers in Noida</a> and across <a href="/wedding-caterers-in-delhi" class="link-underline">Delhi</a>.',
  ...
  leadership: {
    ...
    paragraphs: [
      ...
      'Virtuoso Catering House is based at A-15, A-Block, Sector 61, Noida, Uttar Pradesh, India, and caters across Delhi NCR, including Noida, <a href="/catering-services-in-greater-noida" class="link-underline">Greater Noida</a>, <a href="/wedding-caterers-in-delhi" class="link-underline">Delhi</a> and Gurugram.'
    ]
  },
  closing: {
...
const commercialPages = [
  ...
  { path: '/wedding-caterers-in-noida', label: 'Wedding Caterers, Noida', blurb: 'A menu for every function, from the mehendi to the reception.' },
