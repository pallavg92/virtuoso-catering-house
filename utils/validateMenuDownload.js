...
const { EMAIL_RE, PHONE_RE, sanitiseAttribution } = require('./validateInquiry');
...
function extractFields(body) {
  return {
    ...
    // Same treatment as the enquiry form: diagnostic only, never validated,
    // never able to block a download. See public/js/attribution.js.
